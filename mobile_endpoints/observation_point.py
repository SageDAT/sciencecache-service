...
class mobile_observation_point_end_point():


    def edit_permissions(self,header_uuid,observation_point_id):
        return True
    ...
    #     if(not self.edit_permissions(header_uuid,observation_point_id)):
    #         raise falcon.HTTPUnauthorized(
    #             description='You do not have permission to edit this Observation Point'
    #         )
    #
    #     try:
    #         # load the request body
    ...
    #     if(not self.edit_permissions(header_uuid,observation_point_id)):
    #         raise falcon.HTTPUnauthorized(
    #             description='You do not have permission to delete this Observation Point'
    #         )
    #
    #     try:
    #         #find observation point
